...
let settings = {
        ...
        async function connectToServer() {
            ...
            if (__TC_IS_HTTPS_PAGE) {
                ...
                console.warn('[Goals Widget - shares] P�gina servida en HTTPS sin uid: no se puede conectar al servidor local.');
                return;
            }
            ...
            if(typeof io !== 'undefined') {
                ...
                socket.on('connect_error', (error) => {
                    console.error('[Goals Widget - shares] Error de conexi�n Socket.IO:', error);
                });
                ...
                socket.on('goals:accumulator:update', (data) => {
                    try {
                        ...
                        console.error('[Goals Widget - shares] Error procesando actualizaci�n:', e);
                    }
                });
            }
        }
