// TikControl Border - Minecraft Plugin Integration via ServerTap

const { ipcMain } = require('electron');

const GAME_ID = 'tikcontrol-border';
const GAME_NAME = 'TikControl Border';
const IPC_PREFIX = 'tikcontrolborder';
