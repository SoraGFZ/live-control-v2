// TikControl BarberShop - Minecraft Plugin Integration via ServerTap

const { ipcMain } = require('electron');

const GAME_ID = 'tikcontrol-barbershop';
const GAME_NAME = 'TikControl BarberShop';
const IPC_PREFIX = 'tikcontrolbarbershop';
