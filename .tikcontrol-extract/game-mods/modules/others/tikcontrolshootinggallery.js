// TikControl Shooting Gallery - Minecraft Plugin Integration via ServerTap

const { ipcMain } = require('electron');

const GAME_ID = 'tikcontrol-shootinggallery';
const GAME_NAME = 'TikControl Shooting Gallery';
const IPC_PREFIX = 'tikcontrolshootinggallery';
