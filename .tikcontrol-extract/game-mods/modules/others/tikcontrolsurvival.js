// TikControl Survival - Minecraft Plugin Integration via ServerTap

const { ipcMain } = require('electron');

const GAME_ID = 'tikcontrol-survival';
const GAME_NAME = 'TikControl Survival';
const IPC_PREFIX = 'tikcontrolsurvival';
