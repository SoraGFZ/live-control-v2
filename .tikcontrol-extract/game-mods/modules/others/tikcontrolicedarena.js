// TikControl Iced Arena - Minecraft Plugin Integration via ServerTap

const { ipcMain } = require('electron');

const GAME_ID = 'tikcontrol-icedarena';
const GAME_NAME = 'TikControl Iced Arena';
const IPC_PREFIX = 'tikcontrolicedarena';
