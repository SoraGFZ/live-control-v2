// TikControl SheepOut - Minecraft Plugin Integration via ServerTap

const { ipcMain } = require('electron');

const GAME_ID = 'tikcontrol-sheepout';
const GAME_NAME = 'TikControl SheepOut';
const IPC_PREFIX = 'tikcontrolsheepout';
