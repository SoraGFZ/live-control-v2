// TikControl Painting - Minecraft Plugin Integration via ServerTap

const { ipcMain } = require('electron');

const GAME_ID = 'tikcontrol-painting';
const GAME_NAME = 'TikControl Painting';
const IPC_PREFIX = 'tikcontrolpainting';
