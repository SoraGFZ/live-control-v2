// TikControl Ladder - Minecraft Plugin Integration via ServerTap

const { ipcMain } = require('electron');

const GAME_ID = 'tikcontrol-ladder';
const GAME_NAME = 'TikControl Ladder';
const IPC_PREFIX = 'tikcontrolladder';
