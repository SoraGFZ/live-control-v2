// TikControl Building - Minecraft Plugin Integration via ServerTap

const { ipcMain } = require('electron');

const GAME_ID = 'tikcontrol-building';
const GAME_NAME = 'TikControl Building';
const IPC_PREFIX = 'tikcontrolbuilding';
