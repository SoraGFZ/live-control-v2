// TikControl Parkour - Minecraft Plugin Integration via ServerTap

const { ipcMain } = require('electron');
const fs = require('fs');
const path = require('path');

const GAME_ID = 'tikcontrol-parkour';
const GAME_NAME = 'TikControl Parkour';
const IPC_PREFIX = 'tikcontrolparkour';
...
async function sendEffect(effectId, options = {}) {
  ...
  // Replace {nickname} if still present
  if (options.nickname) {
