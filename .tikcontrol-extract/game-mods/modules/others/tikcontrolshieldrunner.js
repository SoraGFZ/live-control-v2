// TikControl Shield Runner - Minecraft Plugin Integration via ServerTap

const { ipcMain } = require('electron');

const GAME_ID = 'tikcontrol-shieldrunner';
const GAME_NAME = 'TikControl Shield Runner';
const IPC_PREFIX = 'tikcontrolshieldrunner';
