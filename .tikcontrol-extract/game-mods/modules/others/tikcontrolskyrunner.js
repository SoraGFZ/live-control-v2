// TikControl SkyRunner - Minecraft Plugin Integration via ServerTap

const { ipcMain } = require('electron');

const GAME_ID = 'tikcontrol-skyrunner';
const GAME_NAME = 'TikControl SkyRunner';
const IPC_PREFIX = 'tikcontrolskyrunner';
