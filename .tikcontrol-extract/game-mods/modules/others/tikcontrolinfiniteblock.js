// TikControl Infinite Block - Minecraft Plugin Integration via ServerTap

const { ipcMain } = require('electron');

const GAME_ID = 'tikcontrol-infiniteblock';
const GAME_NAME = 'TikControl Infinite Block';
const IPC_PREFIX = 'tikcontrolinfiniteblock';
