// TikControl Battlefield - Minecraft Plugin Integration via ServerTap

const { ipcMain } = require('electron');

const GAME_ID = 'tikcontrol-battlefield';
const GAME_NAME = 'TikControl Battlefield';
const IPC_PREFIX = 'tikcontrolbattlefield';
