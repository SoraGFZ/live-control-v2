// TikControl SandWall - Minecraft Plugin Integration via ServerTap

const { ipcMain } = require('electron');

const GAME_ID = 'tikcontrol-sandwall';
const GAME_NAME = 'TikControl SandWall';
const IPC_PREFIX = 'tikcontrolsandwall';
