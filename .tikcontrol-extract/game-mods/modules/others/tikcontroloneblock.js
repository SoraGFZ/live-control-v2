// TikControl OneBlock - Minecraft Plugin Integration via ServerTap

const { ipcMain } = require('electron');

const GAME_ID = 'tikcontrol-oneblock';
const GAME_NAME = 'TikControl OneBlock';
const IPC_PREFIX = 'tikcontroloneblock';
