// TikControl Pots Arena - Minecraft Plugin Integration via ServerTap

const { ipcMain } = require('electron');

const GAME_ID = 'tikcontrol-potsarena';
const GAME_NAME = 'TikControl Pots Arena';
const IPC_PREFIX = 'tikcontrolpotsarena';
